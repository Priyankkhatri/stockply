  ...
  return (
    ...
    >
          ...
          <motion.div variants={rowAnim}>
            <GlassCard className="p-10" hover={false}>
              ...
              <div className="space-y-8">
                <div>
                  <label className="text-[10px] font-black text-text/70 uppercase tracking-[0.2em] block mb-3">
                    Company Name
                  </label>
                  <input
                    type="text"
              ...
              <div className="space-y-4">
                {[
                  ...
                  >
                    ...
                    <p className="text-[10px] text-text/70 font-medium leading-relaxed pl-9">{method.desc}</p>
                  </button>
                ))}
              </div>
            </GlassCard>
          ...
          <motion.div variants={rowAnim}>
            <GlassCard className="p-10" hover={false}>
                ...
                {[
                  ...
                  <div key={item.id} className="flex items-center justify-between p-4 rounded-2xl hover:bg-white/50 transition-all border border-transparent hover:border-text/5">
                    <div>
                      ...
                      <p className="text-[10px] text-text/70 font-medium">{item.desc}</p>
                    </div>
                    <button
              ...
              <div className="mt-8 p-6 bg-white/50 rounded-2xl border border-text/5 flex gap-4">
                ...
                <p className="text-[10px] text-text/70 italic leading-relaxed">
      ...
      <motion.div variants={rowAnim} className="mt-12 flex justify-end items-center gap-6">
        <button className="text-[10px] font-black text-text/70 uppercase tracking-[0.2em] hover:text-text transition-all" type="button">
          Discard Changes
        </button>
        <button 
          onClick={() => {
