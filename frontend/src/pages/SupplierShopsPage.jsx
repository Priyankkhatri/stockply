      ...
      <motion.div variants={rowAnim}>
        <GlassCard className="p-6 mb-8 flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between" hover={false}>
          <div className="relative w-full max-w-2xl group">
            <Search className="absolute left-5 top-1/2 -translate-y-1/2 text-text/70 group-focus-within:text-primary transition-colors" size={18} />
            <input
              value={searchTerm}
              onChange={(event) => setSearchTerm(event.target.value)}
              type="text"
              placeholder="Find a partner by name, category, or city..."
              className="w-full rounded-2xl border border-transparent bg-background/50 py-4 pl-14 pr-6 text-sm font-bold text-text placeholder:text-text/70 focus:border-primary/20 focus:bg-white focus:outline-none transition-all"
            />
          </div>
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <button className="rounded-2xl border border-text/5 bg-white/80 p-4 text-text/70 transition-all hover:text-primary hover:border-primary/20">
              <Filter size={18} />
            </button>
          </div>
        </GlassCard>
          ...
          <button
            ...
            className={`rounded-full border px-5 py-2.5 text-xs font-black uppercase tracking-[0.2em] transition-all ${
              activeFilter === filter
                ...
                : 'border-text/5 bg-white text-text/70 hover:border-primary/20 hover:text-primary'
            }`}
          >
            {filter}
          </button>
      ...
      <motion.div variants={rowAnim}>
        <GlassCard className="hidden lg:block overflow-hidden p-0" hover={false}>
            ...
            <table className="w-full border-collapse text-left">
              <thead>
                <tr className="border-b border-[#F0E5D8] bg-[#FAF5F0]/80">
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-text/70">Partner Identity</th>
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-text/70">Industry</th>
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-text/70">Geography</th>
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-text/70">Financials</th>
                  <th className="px-10 py-6 text-center text-[10px] font-black uppercase tracking-[0.2em] text-text/70">Trust Metric</th>
                  <th className="px-10 py-6 text-center text-[10px] font-black uppercase tracking-[0.2em] text-text/70">Status</th>
                  <th className="px-10 py-6 text-right text-[10px] font-black uppercase tracking-[0.2em] text-text/70" />
                </tr>
              </thead>
                  ...
                  return (
                    ...
                    >
                      <td className="px-10 py-8">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <span className="mt-1 block text-[10px] font-black uppercase tracking-widest text-text/70">Partner since {new Date(shop.createdAt).getFullYear() || 2024}</span>
                          </div>
                        </div>
                      </td>
                      <td className="px-10 py-8">
                        <span className="rounded-lg border border-text/5 bg-white px-3 py-1 text-[9px] font-black uppercase tracking-widest text-text/70 shadow-sm">
                      ...
                      <td className="px-10 py-8">
                        ...
                        <p className="text-[10px] font-bold tracking-widest text-text/70">{shop.totalOrders || 0} Orders</p>
                      </td>
          ...
          <div className="flex items-center justify-between border-t border-text/5 bg-[#FAF5F0]/40 px-10 py-8">
            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-text/70">
            ...
            <div className="flex items-center gap-4">
              <button className="flex h-12 w-12 items-center justify-center rounded-2xl border border-text/5 bg-white/50 text-text/70 transition-all hover:bg-white hover:text-primary hover:shadow-md">
                <ChevronLeft size={20} />
              </button>
              <button className="flex h-12 w-12 items-center justify-center rounded-2xl border border-text/5 bg-white text-text/70 shadow-sm transition-all hover:text-primary hover:shadow-md">
      ...
      <div className="grid grid-cols-1 gap-4 lg:hidden">
          ...
          return (
            ...
            >
              <div className="mb-6 flex items-start justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] font-black uppercase tracking-widest text-text/70">Partner since {new Date(shop.createdAt).getFullYear() || 2024}</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="space-y-1">
                  <p className="text-[8px] font-black uppercase tracking-widest text-text/70">Industry</p>
                  <p className="text-xs font-bold text-text">{shop.category || 'General'}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[8px] font-black uppercase tracking-widest text-text/70">Financials</p>
                  <p className="text-xs font-black text-text">{shop.revenue || 'Rs. 0'}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[8px] font-black uppercase tracking-widest text-text/70">Location</p>
                ...
                <div className="space-y-1">
                  <p className="text-[8px] font-black uppercase tracking-widest text-text/70">Total Orders</p>
        ...
        {visibleShops.length === 0 && (
          <div className="flex flex-col items-center justify-center py-12 px-6 text-center">
            ...
            <p className="text-xs text-text/70 mt-2">Try refining your search or filter criteria.</p>
          </div>
        )}
      </div>
            ...
            >
              <div className="p-10 border-b border-text/5 flex justify-between items-center bg-background/50">
                <div>
                  ...
                  <p className="text-[10px] font-black text-text/70 uppercase tracking-[0.2em] mt-1">Establishing shop connection</p>
                </div>
                <button 
                  onClick={() => setIsAddModalOpen(false)}
                  className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-text/70 hover:text-text transition-colors shadow-sm"
                >
              ...
              <div className="p-10 grid grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-text/70 uppercase tracking-widest ml-1">Shop Name</label>
                  <input 
                    type="text" 
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-text/70 uppercase tracking-widest ml-1">Geography (City)</label>
                  <input 
                    type="text" 
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-text/70 uppercase tracking-widest ml-1">Industry Category</label>
                  <select 
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-text/70 uppercase tracking-widest ml-1">Initial Status</label>
                  <select 
              ...
              <div className="px-10 py-8 bg-background/50 border-t border-text/5 flex items-center justify-end gap-4">
                <button 
                  onClick={() => setIsAddModalOpen(false)}
                  className="px-8 py-4 text-xs font-black uppercase tracking-widest text-text/70 hover:text-text transition-colors"
                >
                  Discard
                </button>
