      ...
      `}>
        ...
        <div className="p-6 pt-8 flex items-center justify-between">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[7px] font-black text-text/70 tracking-[0.4em] uppercase mt-1.5 flex items-center gap-1.5">
          ...
          <button 
            onClick={onClose}
            className="lg:hidden p-2 text-text/70 hover:text-text transition-colors bg-text/5 rounded-xl"
          >
            <X size={20} />
          </button>
        </div>
              ...
              return (
                <NavLink
                  ...
                  className={`group relative flex items-center justify-between px-4 py-3 rounded-[18px] transition-all duration-500 ${
                    isActive
                       ? 'text-text'
                      : 'text-text/70 hover:text-text/80 hover:bg-text/[0.02]'
                  }`}
                >
                  {isActive && (
                    <motion.div 
                  ...
                  <div className="relative z-10 flex items-center gap-4">
                    <div className={`p-2.5 rounded-14 transition-all duration-500 ${isActive ? 'bg-primary/10 text-primary' : 'text-text/70 group-hover:text-text/70'}`}>
                      <link.icon size={18} strokeWidth={isActive ? 2.5 : 2} />
                    </div>
                    <div className="flex flex-col">
                      <span className="text-[10px] font-black uppercase tracking-widest">{link.name}</span>
                      <span className={`text-[8px] font-bold italic transition-all duration-500 ${isActive ? 'text-text/70 opacity-100' : 'opacity-0 -translate-y-1 group-hover:opacity-60 group-hover:translate-y-0'}`}>
                        {link.detail}
                      </span>
                    </div>
                  </div>
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="pt-4 border-t border-text/5 space-y-1">
            <NavLink
              to="/support"
              className="flex items-center gap-4 px-5 py-3.5 rounded-[18px] text-[10px] font-black uppercase tracking-widest text-text/70 hover:text-text hover:bg-text/[0.02] transition-all"
            >
          ...
          <div className="flex items-center justify-center gap-2 pt-2">
            ...
            <span className="text-[8px] font-bold text-text/70 uppercase tracking-[0.3em]">Secure Atelier System</span>
          </div>
        </div>
      </aside>
    );
